...
function createFunction() {
  ...
  function after(count, func) {
    var counter = 1;
      ...
      function helloAfterCount() {
      if(counter === count) return func();
      counter ++;
    }
    
    return helloAfterCount;
  }
...
const delayFunc = delay(function(num) {console.log(`this is the first message: ${num}`)}, 1000, 1 )
delayFunc
...
samp
  ...
  function rollCall(names) {
    var counter = 0;
      ...
      function printElement() {
        ...
        if(counter === index) console.log(element);
      });
  ...
  function saveOutput(func, magicWord) {
    ...
    function whatsThePassword(y) {
      
      if(y === magicWord) return obj;
      else{
        obj = Object.assign({[y]: func(y)}, obj);
        return func(y);
      }
    }
    
    return whatsThePassword;
  ...
  function cycleIterator(array) {
    var counter = 0;
      ...
      counter++;
      if(counter % (array.length + 1) === 0)counter = 1;
      
      for(let i = 0; i < array.length; i++) {
        if((counter) === i + 1 ) return array[i];
      }
  ...
  function dateStamp(func) {
    ...
    function dateAndOutput(y){
      var dateToday = new Date().toLocaleDateString();
          var obj = {...{date: dateToday}, ...{output: func(y)}};
      
      return obj
      }
    
    return dateAndOutput;
    ...
    var container = [];
      ...
      if(arguments.length > 1) {
        ...
        container.forEach(function(obj){
             singleArg = singleArg.replace(obj[0],obj[1])
  ...
  function russianRoulette(num) {
    ...
    function SMT() {
      ...
      else if (counter < num) return 'click';
  ...
  const play2 = russianRoulette(5);
  console.log(play2()); // => should log 'click'
  console.log(play2()); // => should log 'click'
  console.log(play2()); // => should log 'click'
  console.log(play2()); // => should log 'click'
  console.log(play2()); // => should log 'bang'
  console.log(play2()); // => should log 'reload to play again'
  console.log(play2()); // => should log 'reload to play again
  ...
  function makeFuncTester(arrOfTests) {
    ...
    function compareStrings(func) {
      
      for(let i = 0; i < arrOfTests.length; i++) {
   
        console.log(func(arrOfTests[i][0]), arrOfTests[i][1])
        if(func(arrOfTests[i][0]) !== arrOfTests[i][1]) return false;
      }
